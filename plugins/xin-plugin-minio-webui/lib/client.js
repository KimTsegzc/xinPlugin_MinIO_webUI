	...
	factory: (require) => {
		...
		function apply(ctx) {
			...
			function ConfigDialog({ state, onClose, onSaved }) {
				...
				const testRag = () => { setStatus('RAG 测试中…'); setRagResult(null); api('testRag', { config: form }).then((r) => { setRagResult(r); setStatus(''); }).catch((e) => { setRagResult({ error: String(e && e.message || e) }); setStatus(''); }); };
				...
				return React.createElement('div', { className: 'kb-mask', onClick: onClose },
					React.createElement('div', { className: 'kb-dialog', onClick: (e) => e.stopPropagation() },
						...
						React.createElement('div', { className: 'kb-dialog-body' },
							React.createElement('div', { className: 'kb-section' }, 'MinIO'),
							...
							React.createElement('div', { className: 'kb-section' }, 'RAG-MCP（Chroma 知识库）'),
							...
							React.createElement('div', { className: 'kb-field' },
								React.createElement('button', { className: 'kb-btn', onClick: testRag }, '测试RAG-MCP'),
								ragResult ? React.createElement('div', { className: 'kb-rag-check' }, ragChecks, ragResult.error ? React.createElement('div', { className: 'kb-rag-item bad' }, '⚠️ ' + ragResult.error) : null) : null),
